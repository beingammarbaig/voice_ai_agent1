    ...
    const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "You are a precise data extraction assistant. Return only JSON — no explanations.",
          },
...
`;
  ...
  // ✅ Use the datetime exactly as given by OpenAI (no timezone conversion)
